window.SITE = {
  ...
  navCta: "Call now",
  chips: ["Glendale", "15 years", "West Valley"],
  cards: [
    { t: "Carpet & tile", d: "Carpet, tile, grout. Homes and businesses." },
    { t: "Windows & solar", d: "Windows, screens, solar panels. West Valley sun is brutal." },
  ...
  steps: [
    ...
    { n: "03", t: "Walk into clean", d: "Detail work. No shortcuts. The new site is this one." }
  ]
};
